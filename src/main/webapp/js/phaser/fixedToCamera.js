var game = new Phaser.Game(800, 600, Phaser.CANVAS, 'image', {
    preload: preload,
    create: create,
    update: update,
    render: render
...
function preload() {
    ...
    game.load.image('mushroom', '../assets/phaser/sprites/mushroom2.png');
    game.load.image('sonic', '../assets/phaser/sprites/sonic_havok_sanity.png');
    game.load.image('phaser', '../assets/phaser/sprites/phaser1.png');
}
